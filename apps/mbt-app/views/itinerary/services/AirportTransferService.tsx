...
const AirportTransferService = () => {
	...
	useEffect(() => {
		setActions([
			...
			},
			{
				...
				Icon: HiOutlineSave,
				variant: "primary",
				onClick: async () => {  // NOTE: Why not set the function above instead?
					setLoading(true);
					try {
	...
	}, [loading, services, selectedDate, exportServices, popView, clearActions, setActions]);
  ...
  return (
    <div className="m-5 flex flex-col h-[68vh]">
      ...
      <div className="flex-1 flex">
	    ...
	    {/* DETAIL MODAL  */}
	    {/* TODO: Why can't we use the detail modal from the shared components folder? */}
	    {selected && (
