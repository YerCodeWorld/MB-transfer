...
export async function fetchAtData(date?: string): Promise<{ bookings: any[], date: string } | null> {
  ...
  const headers = {
    ...
    "Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..MSda6UJU0rvAYVM1lwC2MGyLUOIYb4gs08MJVDFA8DrXVPSpcVPNPqAxMnu38hz_GrfHvbdCRxHnegpOAIoDZ_bagwfhGmtwglww8pfEfDC9lYKWcKOcgqumxZ1LGxEmzfkKJVPzxgJGjxlJo2KR_-KU0uNbO6RYaqVdM5-wkHBJVHNdnuBTYcUFbqcFvrZocAVlQCHgqopDv3TUIZhbh_89Cgv6gp58yMO4dMvLA6A2WXTcLY6QRzmc0xq5cxklytir2Kuis9Ct7o0T_wP7yxB_gkUavl5ifXFsjdbTd842aH1clSRxjIevnx5flzLe_VLvaxSDwuaoruzozr8jx59umrfAUSYmFmVd2IyPIreRSq0GgBneR0NDBX1YxLLkGyDv-3hGIJex3HMc6N_kDO0Oi4ps5VRBoe0yEPaIsCNa8-xZAiFVtNKN9NGo3Y-lCmGC-7rqzvmAAdYDZbm2Ogvx8ZztnedxYgMBhfxIvuaqQ0fTIhYhA5VZQiq-Gtvgj6Woiif3DscqXBQ_nti-EmRDEhmdZYsBhxeJohSCGE75ue2sjCKxPt42wR_VVKTahLWIT0rPDFRLhfaTx7r9PnBMDTtcyfn2JyWsd_vs99GAGmZ0OyvUURlAgWJ4vaRU_8aaVYZkDKwaNHY1WSgLCOVHAVIvu5bBT7hLPk_-9Io"
  };
