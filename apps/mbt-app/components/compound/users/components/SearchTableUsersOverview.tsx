  ...
  return (
    <Card extra={"w-full h-full sm:overflow-auto px-6"}>
      <div className="flex w-[400px] max-w-full items-center rounded-xl pt-[20px]">
        <div className="flex h-[38px] w-[400px] flex-grow items-center rounded-xl bg-lightPrimary text-sm text-gray-600 dark:!bg-navy-900 dark:text-white gap-2 p-2">
          <FiSearch />
          <input
            value={globalFilter ?? ""}
      ...
      <div className="mt-8 overflow-x-scroll xl:overflow-x-hidden">
        ...
        <div className="mt-2 flex h-20 w-full items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            <p className="> Show rows per page text-sm text-gray-700 dark:text-accent-50">
              Mostrando 6 trabajadores por página
            </p>
          </div>
          {/* right side */}
