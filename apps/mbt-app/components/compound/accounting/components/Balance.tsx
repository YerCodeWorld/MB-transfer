...
import CardMenu from "../../../single/card/CardMenu";
import Card from "../../../single/card";
import Transaction from "../../../single/datadisplay/Transaction";

function Balance() {
  return (
    <Card extra={"p-4 h-full"}>
      <div
        className={`bg-image relative mt-[7px] flex h-fit w-full justify-between rounded-xl bg-accent-900 bg-ballanceDashboard bg-cover bg-right px-3 py-4 text-white dark:bg-navy-700`}
      >
        <div>
